...
>
  ...
  <h1 className="text-3xl sm:text-4xl md:text-5xl -ml-8 md:-ml-16 lg:text-5xl font-jakarta">
 Bulk<span className="text-blue-400 font-bold"> Sms</span>
</h1>
  ...
  <div className="flex  gap-2 text-[10px] sm:text-lg mb-8">
    ...
    <span className="text-blue-400">★</span>
    <span className="text-blue-400">Bulk SMS</span>
  </div>
</div>
