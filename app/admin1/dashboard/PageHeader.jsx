...
export default function PageHeader({ onMenuToggle }) {
  ...
  <ul className="py-1 pl-0 list-none">  {/* 👈 reset UL padding & bullets */}
  ...
  <ul className="py-1 text-sm text-gray-700 list-none pl-0 m-0"> {/* reset ul padding/bullets */}
    <li>
      <button
      ...
      >
        ...
        <div className="relative" ref={shortcutsRef}>
          <button
            ...
            className="inline-flex  items-center justify-center h-10 w-10 hover:bg-slate-200 rounded-full focus:outline-none"
            aria-haspopup="menu"
          ...
          {openShortcuts && (
            <div className="absolute right-0 -left-40 md:-left-72 p-2 w-[300px] md:w-[400px] bg-white border border-gray-200 rounded-[5px] shadow-lg z-50">
              {/* Header */}
  ...
  "
            >
              ...
              <div className="flex items-center justify-between px-3 py-3 border-b border-gray-300 ">
                <h6 className="text-[15px] font-medium text-gray-700">
                  Notification
                </h6>
                <div className="flex items-center gap-2">
                  ...
                  >
                    <IconMailOpened stroke={2}  size={20}  tooltip="Mark all as read" className="text-gray-800" />
                  </button>
                </div>
              </div>
