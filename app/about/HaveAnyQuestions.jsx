...
const faqs = [
  {
    ...
    answer:
      "We offer a full range of digital marketing, web development, and consulting services tailored to your business needs.",
  },
  {
    question: "How long does a typical project take?",
    answer:
      "Project duration varies based on scope, but typically ranges from 4-12 weeks.",
  },
  {
    question: "Do you work with small businesses?",
    answer:
      "Yes! We specialize in helping small businesses grow online efficiently.",
  },
  {
    question: "Can you help with existing websites?",
    answer:
      "Absolutely. We can optimize, redesign, or maintain your current website to improve performance and conversions.",
  },
];
...
export default function HaveAnyQuestions() {
  ...
  return (
    <div className="flex flex-col lg:flex-row bg-black text-white min-h-screen mt-16 md:mt-12 p-8 lg:p-16 gap-8">
      <div className="relative flex-1 grid grid-cols-1 gap-4">
        <div className="relative">
          <img
            src="https://demo.awaikenthemes.com/artistics/wp-content/uploads/2024/11/faq-img-2.jpg"
            alt="Team"
            className="rounded-2xl w-[85%] md:mt-24 object-cover shadow-lg"
          />

          
          <div
            className="absolute bottom-8 animate-side-move right-[15%] bg-gray-800 border md:w-[240px]  md:px-4 py-2 md:mb-4 rounded-lg shadow-lg transition-all duration-300 hover:-translate-x-5 hover:shadow-xl"
            style={{ borderRadius: "10px" }}
          >
            <Link href="tel:(30)%208855-314" className="flex items-center gap-3">
             
              <span className="text-green-400 transition-colors duration-300 hover:text-green-500">
                <svg
        ...
        <img
          src="https://demo.awaikenthemes.com/artistics/wp-content/uploads/2024/11/faq-img-1.jpg"
          alt="Smiling person"
          className="absolute top-0 right-4 transform -translate-y-1/4 rounded-2xl w-1/2 object-cover shadow-xl"
        />
      </div>

     
      <div className="flex-1 flex flex-col md:-mt-32 justify-center gap-6">
        <div className="mb-4">
          <div className="inline-flex items-center gap-2 text-sm font-medium text-blue-400 mb-0 md:mb-4 lg:mb-4">
            <div className="text-white text-[16px] mr-2 "><span className="text-blue-400 text-[16px]">✱</span>{" "}HAVE ANY{" "} QUESTIONS?</div>
            
          </div>
        </div>
        <h2 className="text-4xl md:-mt-8 md:text-6xl lg:text-6xl font-jakarta">
          Let us address your <span className="text-blue-400 font-bold">questions</span>{" "}
          today!
        </h2>
         ...
         <div className="space-y-4 ">
          {faqs.map((faq, index) => (
            <div
              key={index}
              className="bg-gradient-to-b md:mb-10 from-gray-900 to-black rounded-xl  p-5 cursor-pointer transition"
