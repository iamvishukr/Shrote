...
export default function Portfolio() {
  ...
  const projects = [
    ...
    },
    {
      ...
      url: "/products",
      year: "2025",
      description: "Multi-channel autonomous AI support engine with CRM sync, vector RAG database retrieval, and real-time sentiment analytics.",
    },
    {
      id: 121,
      ...
      url: "/products",
      year: "2025",
      description: "Multi-location warehouse ERP system with live barcode tracking, automated purchase orders, and GST e-invoicing.",
    },
    {
      id: 122,
      ...
      year: "2025",
      description: "Investment and wealth tracking app with automated mutual fund SIP portfolios, market feeds, and DigiLocker KYC.",
    },
    {
      id: 1,
