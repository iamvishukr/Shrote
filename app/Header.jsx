...
const megaMenus = {
  Industries: {
    ...
    featured: {
      label: "200+ Clients Served",
      desc: "Across multiple industries pan-India",
      href: "/industries",
    },
  },
  Services: {
    columns: [
      {
        heading: "Development",
        items: [
          { icon: Code2,          label: "Web Development",       href: "/web-development",         desc: "Next.js, React & Node.js" },
          { icon: Smartphone,     label: "App Development",       href: "/application-development", desc: "iOS, Android & Flutter" },
          { icon: Box,            label: "Software Development",  href: "/software-development",    desc: "Custom cloud solutions" },
          { icon: ShoppingBag,    label: "E-Commerce Solution",   href: "/ecommerce-solution",      desc: "Scalable online stores" },
        ],
      },
      {
        heading: "Specialized",
        items: [
          { icon: SearchCheck,    label: "SEO & SEM Services",    href: "/seo-sem",                 desc: "Google rank & traffic" },
          { icon: MessageSquare,  label: "Bulk SMS Services",     href: "/bulk-sms",                desc: "High delivery SMS gateway" },
          { icon: Layout,         label: "Web Design",            href: "/web-design",              desc: "UI/UX & responsive design" },
          { icon: Database,       label: "Data Science & AI",     href: "/data-science-solution",   desc: "Analytics & ML models" },
        ],
      },
    ],
    featured: {
      label: "Custom Solutions",
      desc: "Bespoke software tailored to your workflow",
      href: "/contact",
    },
  },
  Products: {
    columns: [
      {
        ...
        items: [
          { icon: Cpu,            label: "HRMS Software",         href: "/products",                desc: "Complete HR & attendance" },
          { icon: BarChart3,      label: "ERP Suite",             href: "/products",                desc: "Enterprise resource suite" },
          { icon: MessageSquare,  label: "AI Chatbot",            href: "/products",                desc: "Smart customer support" },
          { icon: Landmark,       label: "Payroll Management",    href: "/products",                desc: "Automated salary & tax" },
        ],
      },
      {
        heading: "Industry SaaS",
        items: [
          { icon: Warehouse,      label: "Inventory System",      href: "/products",                desc: "Stock & warehouse tool" },
          { icon: School,         label: "School Management",     href: "/products",                desc: "Students & fee system" },
          { icon: UtensilsCrossed,label: "Restaurant POS",        href: "/products",                desc: "Billing & KOT management" },
          { icon: HeartPulse,     label: "Hospital Management",   href: "/products",                desc: "Patient & clinic software" },
        ],
      },
    ],
    featured: {
      label: "16+ SaaS Products",
      desc: "Explore ready-to-deploy enterprise tools",
      href: "/products",
    },
  },
  Resources: {
    ...
    featured: {
      label: "See Our Work",
      desc: "Explore portfolio of 200+ successful projects",
      href: "/portfolio",
    },
  },
  Careers: {
