...
const sidebarData = [
  ...
  },
  {
    ...
    children: [
      ...
      { title: "Customers List", key: "customers" },
    ],
    icon: <Users size={22} />,
  },
  {
...
export default function Sidebar({
  ...
  const getSidebarClasses = () => {
    if (isMobile) {
      return `bg-white text-gray-600 pl-4 text-[15px] flex flex-col fixed w-[280px] h-full overflow-auto transition-all duration-300 z-40 left-0 top-0
        ${
          isMobileOpen
  ...
  return (
    <>
      ...
      >
        <div className="p-4 -mt-2 border-gray-200 flex items-center justify-between">
